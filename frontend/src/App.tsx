    ...
    <Layout>
      <div className="max-w-2xl mx-auto text-center relative">
        ...
        <p className="text-2xl mb-12 text-purple-200/80 leading-relaxed">
          Control the battlefield with strategy and skill. Capture territories, form alliances, and dominate the realm in this intense area control game.
        </p>
        
        <div className="flex gap-4 justify-center">
          <button 
            className="px-8 py-4 text-xl font-bold rounded-lg bg-gradient-to-r from-purple-800 to-indigo-800 hover:from-purple-700 hover:to-indigo-700 transform transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-purple-700/30 border border-purple-700/30"
          >
